...
song1 = Song.create(title: "Beside Me", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile1 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song2 = Song.create(title: "Cold Water", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile2 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song3 = Song.create(title: "Cover", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile3 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song4 = Song.create(title: "Dark Side", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile4 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song5 = Song.create(title: "Forget Me Not", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile5 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song6 = Song.create(title: "In The Throes", genre: "Ambient", artist_id: artist2.id)
    ...
    photofile6 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song7 = Song.create(title: "Spring Thaw", genre: "Ambient", artist_id: artist2.id)
    ...
    photofile7 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song8 = Song.create(title: "No Starlight Dey Beat", genre: "Dance & Electronic", artist_id: artist3.id)
    ...
    photofile8 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song9 = Song.create(title: "She No Dull Beat", genre: "Dance & Electronic", artist_id: artist3.id)
    ...
    photofile9 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song10 = Song.create(title: "Ocean View", genre: "Dance & Electronic", artist_id: artist1.id)
    ...
    photofile10 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song11 = Song.create(title: "Street Rhapsody", genre: "Hip Hop & Rap", artist_id: artist4.id)
    ...
    photofile11 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
...
song12 = Song.create(title: "Today's Plan", genre: "Hip Hop & Rap", artist_id: artist4.id)
    ...
    photofile12 = open("https://sunnysounds-seed.s3-us-west-1.amazonaws.com/sunny_logo.png")
